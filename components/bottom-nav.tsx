        ...
        {tabs.map((t) => {
          ...
          return (
            <button
              ...
              className="group relative flex min-w-0 flex-1 flex-col items-center justify-center rounded-[1.3rem] py-2 transition-transform duration-150 active:scale-90"
            >
              {/* Active capsule — only behind the selected tab */}
              <span
                className={cn(
                  "absolute left-1/2 top-1 h-[38px] w-[46px] -translate-x-1/2 rounded-2xl transition-all duration-300 ease-out",
              ...
              <span
                className={cn(
                  "relative mt-0.5 text-[9px] font-bold leading-none tracking-tight transition-colors duration-200",
